...
args_list = [
    './model/shear-0.1/model_best.pth.tar',
    './data/sample-classification-bandgap',  # data_options 参数的示例值，假设数据集位于 'path/to/data'
    '-b', '70',  # batch-size 参数的示例值，假设批量大小为 70
...
def save_checkpoint(state, is_best, filename='checkpoint.pth0.tar'):
